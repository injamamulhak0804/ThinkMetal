  ...
  return (
    <>
        <main className='relative md:text-center font-inter  px-5 md:px-0 md:mt-20 mt-10'>
            <h1 className='md:text-[3.2rem] text-[2.5rem] text-start md:text-center leading-[2.6rem] md:leading-[3.7rem] md:max-w-[75%] font-semibold md:mx-auto font-inter'>Create, inspect, and apply synthetic surveillance broadly.</h1>
            <p className='text-[#5f5f5fe0] text-start md:text-center font-inter text-sm my-6 md:my-3'>Start with a stunning homepage. Stay motivated without hurting your pocket.</p>
            <Button className="text-start" text="Start for free" />
            ...
            <img className='w-full absolute top-[150%] md:top-[100%] left-1/2 transform -translate-x-1/2 -translate-y-1/2' src={HERO_IMG} alt="" />
