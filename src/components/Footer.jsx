  ...
  return (
    <>
      <section>
        <div className='flex flex-col font-inter justify-center items-center'>
            ...
            <h3 className='text-[1.5rem] font-semibold font-inter'>Increase your team’s visibility and alignment</h3>
            <p className='text-xs text-[#525252]'>Start for free, flexible for all teams.</p>
            <div className='mt-10'>
                <button className='cursor-pointer me-5 font-semibold'>Request a demo</button>
    ...
    <footer className='mt-[150px] font-inter max-w-[80%] mx-auto'>
         <div className='flex gap-x-32 items-start'>
            <img className='w-10' src={LOGO_ORANGE} alt="" />
         <div>
